...
namespace eval ttk::theme::kewlthem {
    ...
    set directory [file join [file dirname [info script]] png]
    variable images
    # Load the images
    ...
    ttk::style theme create kewlthem -parent default -settings {
        ...
        ttk::style layout Vertical.TScrollbar {
            Vertical.Scrollbar.trough -sticky ns -children {
                Vertical.Scrollbar.thumb -expand false
            }
        }
        ...
        ttk::style element create Button.button image [list $images(button) \
            ...
            ] -border 3 -padding {1 2} -sticky ewns
        ...
        ttk::style element create Vertical.Scrollbar.trough image $images(empty)
        ...
        ttk::style element create Spinbox.uparrow \
            image [list $images(arrow-bg-up) \
                        pressed   $images(arrow-bg-up) \
                        active    $images(arrow-bg-up) \
                        disabled  $images(arrow-bg-up) \
            ] -width 2 -border {0 2 3 0} -padding {1 2 3 1}
        ...
        ttk::style element create Spinbox.downarrow \
            image [list $images(arrow-bg-down) \
                        pressed   $images(arrow-bg-down) \
                        active    $images(arrow-bg-down) \
                        disabled  $images(arrow-bg-down) \
            ] -width 2 -border {0 0 3 2} -padding {1 1 3 2}
        ttk::style element create Spinbox.symdownarrow \
            image [list $images(arrow-down-small) \
                        active    $images(arrow-down-small-prelight) \
                        pressed   $images(arrow-down-small-prelight) \
                        disabled  $images(arrow-down-small-insens) \
          ]
        ...
        # Settings
        ttk::style configure TButton -padding {8 4 8 4} -width 0 -anchor center
